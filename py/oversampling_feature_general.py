...
def batch_extrac_featuretomat():
    ...
    modelist =[alexnetpath + "oversampling/caffe_alexnet_train_iter_210000.caffemodel",\
               alexnetpath + "oversampling/2caffe_alexnet_train_iter_110000.caffemodel",\
               alexnetpath + "oversampling/3caffe_alexnet_train_iter_110000.caffemodel",\
               alexnetpath + "oversampling/4caffe_alexnet_train_iter_110000.caffemodel",\
               alexnetpath + "oversampling/5caffe_alexnet_train_iter_110000.caffemodel",\
               alexnetpath + "oversampling/7caffe_alexnet_train_iter_110000.caffemodel",\
               alexnetpath + "oversampling/8caffe_alexnet_train_iter_110000.caffemodel",\
               alexnetpath + "oversampling/6caffe_alexnet_train_iter_10000.caffemodel",\
               alexnetpath + "oversampling/9caffe_alexnet_train_iter_20000.caffemodel",\
              ]
    ...
    deploylist=[alexnetpath+"deploy.prototxt",
                ...
                alexnetpath+"deploy.prototxt",
                alexnetpath+"deploy.prototxt",
                alexnetpath+"deploy237.prototxt",
                ]

    # meanlist=[alexnetpath+"patchcifa10_256_mean.binaryproto",
    meanlist=[alexnetpath+"oversampling/patchh1_mean_100.binaryproto",
              alexnetpath+"oversampling/patchh2_mean_100.binaryproto",
              alexnetpath+"oversampling/patchh3_mean_100.binaryproto",
              alexnetpath+"oversampling/patcht11_mean_100.binaryproto",
              alexnetpath+"oversampling/patcht12_mean_100.binaryproto",
              alexnetpath+"oversampling/patcht21_mean_100.binaryproto",
              alexnetpath+"oversampling/patcht22_mean_100.binaryproto",
              alexnetpath+"oversampling/patcht13_mean_100.binaryproto",
              alexnetpath+"oversampling/patcht23_mean_100.binaryproto",
              # alexnetpath+"/oversampling/patchht22_mean_100.binaryproto",
              # alexnetpath+"/oversampling/patchht23_mean_100.binaryproto",
              ]
    ...
    # outlist=["cifar10_alex_oversmaple.mat","cifar10_alex_ori.mat","cifar10_cifar10_dvn.mat",
             ...
             # ]
    outlist=["cifar100_alex_mfseoverh1.mat","cifar100_alex_mfseoverh2.mat","cifar100_alex_mfseoverh3.mat",
             "cifar100_alex_mfseovert11.mat","cifar100_alex_mfseovert12.mat","cifar100_alex_mfseovert13.mat",
             # "cifar10_alex_mfset21.mat",]#"cifar10_alex_mfset22.mat","cifar10_alex_mfset23.mat",
             "cifar100_alex_mfsetover21.mat","cifar100_alex_mfseovert22.mat","cifar100_alex_mfseovert23.mat"]
#]
