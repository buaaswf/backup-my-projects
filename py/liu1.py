...
def loadmodel(caffepath='../', modelpath='models/casiaface/casia.caffemodel',
              deployroot='models/casiaface/casia_train_deploy.prototxt', meanroot='data/idface/casia_web.npy',
              shapelist=[64, 3, 100, 100]):
...
def image2mat(net, transformer, inputimagedir, outdir, labelfilepath, layername):
    ...
    errorimagelist = "./error/mnist_oversmapling_result/" + outdir.split(".")[0]
    ...
    for image in testimages:
        ...
        if out['prob'].argmax() != gtlabel:
            ...
            shutil.copy(image, errorimagelist + "/" + image.split("/")[-1].split(".")[0] + "_pred_" + str(
                out['prob'].argmax()) + ".png")
        # caffe.set_mode_gpu()
        # caffe.set_device(0)
        ...
        #  print "=====>>",lines[nn][1]
        if (nn % 100 == 0):
            with open("./error/mnist_oversmapling_result/" + outdir, 'w') as f:
    ...
    drawroc(labels, predroc, "./error/mnist_oversmapling_result/" + "zoomroc_10" + outdir.split('.')[0] + ".png")
    print "roc=========================>>>>"
    print(classification_report(labels, pred))
    text_file = open("./error/mnist_oversmapling_result/" + outdir.split('.')[0] + ".txt", "w")
    text_file.write(outdir.split('.')[0] + " model\n")
    text_file.write(classification_report(labels, pred))
    import pickle
    with open("./error/mnist_oversmapling_result/" + outdir.split('.')[0] + "_pred.pkl", "wb") as f:
        pickle.dump(mat, f)
    with open("./error/mnist_oversmapling_result/" + outdir.split('.')[0] + "_true.pkl", "wb") as f:
        pickle.dump(labels, f)
    with open("./error/mnist_oversmapling_result/" + outdir, 'w') as f:
        scipy.io.savemat(f, {'data': mat, 'labels': labels})  # append
    cm = confusion_matrix(pred, labels)
    with open("./error/mnist_oversmapling_result/" + outdir.split(".")[0] + ".pkl", "wb") as f:
        pickle.dump(cm, f)
        print cm
        np.savetxt("./error/mnist_oversmapling_result/" + outdir.split(".")[0] + "mfse" + ".csv", cm, delimiter=",")
...
def batch_extrac_featuretomat():
    ...
    modelist = [alexnetpath + "mnist/mnist_oversmapling/result1/caffe_alexnet_train_iter_70000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result2/caffe_alexnet_train_iter_70000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result3/caffe_alexnet_train_iter_70000.caffemodel",\
                alexnetpath + "mnist/mnist_oversmapling/result4/caffe_alexnet_train_iter_120000.caffemodel",\
                alexnetpath + "mnist/mnist_oversmapling/result5/caffe_alexnet_train_iter_50000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result6/caffe_alexnet_train_iter_130000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result7/caffe_alexnet_train_iter_130000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result8/caffe_alexnet_train_iter_130000.caffemodel",\
                alexnetpath + "mnist/mnist_oversmapling/result9/caffe_alexnet_train_iter_130000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result10/caffe_alexnet_train_iter_130000.caffemodel", \
                alexnetpath + "mnist/mnist_oversmapling/result11/caffe_alexnet_train_iter_130000.caffemodel", \
                ]
    ...
    meanlist = [alexnetpath + "mnist/mnist_oversmapling/mean/mean1.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean2.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean3.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean4.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean5.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean6.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean7.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean8.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean9.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean10.binaryproto",
                alexnetpath + "mnist/mnist_oversmapling/mean/mean11.binaryproto",
                ]
    ...
    # ]
    outlist = ["alex_mfseoverh1.mat", "alex_mfseoverh2.mat", "alex_mfseoverh3.mat",
               "alex_mfseoverh4.mat", "alex_mfseoverh5.mat", "alex_mfseoverh6.mat",
               "alex_mfseoverh7.mat", "alex_mfseoverh8.mat", "alex_mfseoverh9.mat",
               "alex_mfseoverh10.mat", "alex_mfseoverh11.mat", ]
    # ]
    layernamelist = ["fc8", "fc8", "fc8", "fc8", "fc8", "fc8", "fc8", "fc8","fc8","fc8","fc8"]
