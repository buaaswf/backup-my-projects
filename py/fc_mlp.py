...
modelnet = 'cifa10/models/cifar10_19layers_iter_200000.caffemodel'
...
net = caffe.Net(caffe_root + 'models/models/cifa10/cifar10_deploy.prototxt',
                caffe_root + 'models/' + modelnet,
                caffe.TEST)
...
transformer.set_mean('data', np.load(caffe_root + 'data/paddedmean.npy').mean(1).mean(1))   # mean pixel
transformer.set_raw_scale('data', 255)  # the reference model operates on images in [0,255] range instead of [0,1]
transformer.set_channel_swap('data', (2, 1, 0))  # the reference model has channels in BGR order instead of RGB
# set net to batch size of 50
net.blobs['data'].reshape(100, 3, 48, 48)
#net.blobs['data'].data[...] = transformer.preprocess('data', caffe.io.load_image(caffe_root + 'data/idface/val/5/flip41211_big.jpg'))
net.blobs['data'].data[...] = transformer.preprocess('data', caffe.io.load_image(caffe_root + '637.png'))
out = net.forward()
