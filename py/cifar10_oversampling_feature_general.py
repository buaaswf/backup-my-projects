...
def image2mat(net,transformer,inputimagedir,outdir,labelfilepath,layername):
    ...
    print "tsnepng=========================>>>>"
    print "zoomroc_10"+outdir.split('.')[0]+".png"
...
def batch_extrac_featuretomat():
    ...
    modelist =[alexnetpath + "0cifar10gen_caffe_alexnet_train_iter_130000.caffemodel",\
               alexnetpath + "1caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "2caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "3caffe_alexnet_train_iter_20000.caffemodel",\
               alexnetpath + "4caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "4caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "6caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "7caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "8caffe_alexnet_train_iter_30000.caffemodel",\
               alexnetpath + "9caffe_alexnet_train_iter_10000.caffemodel",\
               alexnetpath + "10caffe_alexnet_train_iter_10000.caffemodel",\
    ...
    shapelists=[[10,3,227,227],[10,3,227,227],[10,3,227,227],[10,0,227,227],
    ...
    labellist=["cifa10_valdst.csv",
               ...
               "cifa10_valdst.csv",
               "cifa10_valdst.csv",]
    outlist=["cifar10_alex_oversampling0.mat","cifar10_alex_oversampling1.mat","cifar10_alex_oversampling2.mat",
             "cifar10_alex_oversampling3.mat","cifar10_alex_oversampling4.mat","cifar10_alex_oversampling5.mat",
             "cifar10_alex_oversampling6.mat","cifar10_alex_oversampling7.mat","cifar10_alex_oversampling8.mat","cifar10_alex_oversampling9.mat",
             "cifar10_alex_oversampling10.mat",
             ]
