...
def image2mat(net, transformer, inputimagedir, outdir, labelfilepath, layername):
    ...
    errorimagelist = "./error/png_oversmapling_result/" + outdir.split(".")[0]
    ...
    with open("./error/png_oversmapling_result/" + outdir.split(".")[0] + ".pkl", "wb") as f:
        pickle.dump(cm, f)
        print cm
        np.savetxt("./error/png_oversmapling_result/" + outdir.split(".")[0] + "mfse" + ".csv", cm, delimiter=",")
...
def batch_extrac_featuretomat():
    ...
    modelist = [alexnetpath + "mnist/png_oversmapling/result1/caffe_alexnet_train_iter_190000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result2/caffe_alexnet_train_iter_100000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result3/caffe_alexnet_train_iter_100000.caffemodel",\
                alexnetpath + "mnist/png_oversmapling/result4/caffe_alexnet_train_iter_190000.caffemodel",\
                alexnetpath + "mnist/png_oversmapling/result5/caffe_alexnet_train_iter_190000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result6/caffe_alexnet_train_iter_60000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result7/caffe_alexnet_train_iter_130000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result8/caffe_alexnet_train_iter_50000.caffemodel",\
                alexnetpath + "mnist/png_oversmapling/result9/caffe_alexnet_train_iter_50000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result10/caffe_alexnet_train_iter_110000.caffemodel", \
                alexnetpath + "mnist/png_oversmapling/result11/caffe_alexnet_train_iter_100000.caffemodel", \
                ]
    ...
    meanlist = [alexnetpath + "mnist/png_oversmapling/mean/mean1.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean2.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean3.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean4.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean5.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean6.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean7.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean8.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean9.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean10.binaryproto",
                alexnetpath + "mnist/png_oversmapling/mean/mean11.binaryproto",
                ]
