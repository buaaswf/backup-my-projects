...
def image2mat(net,transformer,inputimagedir,outdir,labelfilepath,layername):
    ...
    with open(outdir.split(".")[0]+".pkl","wb") as f:
        pickle.dump(cm,f)
        print cm
        np.savetxt(outdir.split(".")[0]+"ori"+".csv", cm, delimiter=",")
def batch_extrac_featuretomat():
    ...
    modelist =[alexnetpath + "ori/caffe_alexnet_train_iter_127989.caffemodel",\
               alexnetpath + "ori/2caffe_alexnet_train_iter_143744.caffemodel",\
               alexnetpath + "ori/3caffe_alexnet_train_iter_180648.caffemodel",\
               alexnetpath + "ori/4caffe_alexnet_train_iter_165116.caffemodel",\
               alexnetpath + "ori/5caffe_alexnet_train_iter_240000.caffemodel",\
               alexnetpath + "ori/6caffe_alexnet_train_iter_160000.caffemodel",\
               alexnetpath + "ori/7caffe_alexnet_train_iter_74864.caffemodel",\
               alexnetpath + "ori/8caffe_alexnet_train_iter_91434.caffemodel",\
               alexnetpath + "ori/9caffe_alexnet_train_iter_70496.caffemodel",\
              ]
    ...
    meanlist=[alexnetpath+"ori/patchhouse_mean_100.binaryproto",
              alexnetpath+"ori/patchhouse_mean_100.binaryproto",
              alexnetpath+"ori/patchhouse_mean_100.binaryproto",
              alexnetpath+"ori/patchtree1_mean_100.binaryproto",
              alexnetpath+"ori/patchtree1_mean_100.binaryproto",
              alexnetpath+"ori/patchtree1_mean_100.binaryproto",
              alexnetpath+"ori/patchtree2_mean_100.binaryproto",
              alexnetpath+"ori/patchtree2_mean_100.binaryproto",
              alexnetpath+"ori/patchtree2_mean_100.binaryproto",
              # alexnetpath+"/ori/patchht22_mean_100.binaryproto",
              # alexnetpath+"/ori/patchht23_mean_100.binaryproto",
              ]
    ...
    # outlist=["cifar10_alex_oversmaple.mat","cifar10_alex_ori.mat","cifar10_cifar10_dvn.mat",
             ...
             # ]
    outlist=["cifar100_alex_orih1.mat","cifar100_alex_orih2.mat","cifar100_alex_orih3.mat",
             "cifar100_alex_orit11.mat","cifar100_alex_orit12.mat","cifar100_alex_orit13.mat",
             # "cifar10_alex_orit21.mat",]#"cifar10_alex_orit22.mat","cifar10_alex_orit23.mat",
             "cifar100_alex_orit21.mat","cifar100_alex_orit22.mat","cifar100_alex_orit23.mat"]
#]
