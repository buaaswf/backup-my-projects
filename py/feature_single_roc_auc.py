...
def image2mat(net,transformer,inputimagedir,outdir,labelfilepath,layername):
    ...
    for image in testimages[:10000]:
        ...
        # print filters
        # pred.append(net.blobs[net.blobs.keys()[-1]].data[0].flatten())
        pred.append(net.blobs[net.blobs.keys()[-1]].data[0].flatten())
    ...
    print "tsnepng=========================>>>>"
    from plot_roc import drawroc
    drawroc(pred,labels,"zoomroc_"+outdir.split('.')[0]+".png")
    print "roc=========================>>>>"
    import pickle
...
def batch_extrac_featuretomat():
    ...
    hairnetpath="/home/swf/caffe/models/hair/"
    ...
    modelist=[alexnetpath+"dvnciafr10caffe_alexnet_train_iter_450000.caffemodel",\
              ...
              googlenetpath+"bvlc_googlenet_iter_520000.caffemodel",\
              googlenetpath+"oribvlc_googlenet_iter_520000.caffemodel",\
              cifar10netpath+"cifar10_full_0517_iter_600000.caffemodel",\
              cifar10netpath+"cifar10_full_iter_60000.caffemodel",\
              ...
              hairnetpath+"caffenet_train_iter_10000.caffemodel"
    ...
    outlist=["cifar10_alex_dvn.mat","cifar10_alex_ori.mat","cifar10_cifar10_dvn.mat",
             ...
             "svhn_google_dvn.mat","svhn_google_ori.mat", "haircaffenet.mat"
             ]
    layernamelist=["fc8","fc8","loss3/classifier","loss3/classifier","ip1","ip1",
                   "ip1","ip1","fc8","fc8","loss3/classifier","loss3/classifier","fc82"]
