...
def image2mat(net, transformer, inputimagedir, outdir, labelfilepath, layername):
    ...
    errorimagelist = "./error/png_result/" + outdir.split(".")[0]
    ...
    for image in testimages:
        ...
        #  print "=====>>",lines[nn][1]
        if (nn % 100 == 0):
            with open("./error/png_result/" + outdir, 'w') as f:
    ...
    drawroc(labels, predroc, "./error/png_result/" + "zoomroc_10" + outdir.split('.')[0] + ".png")
    print "roc=========================>>>>"
    print(classification_report(labels, pred))
    text_file = open("./error/png_result/" + outdir.split('.')[0] + ".txt", "w")
    text_file.write(outdir.split('.')[0] + " model\n")
    text_file.write(classification_report(labels, pred))
    import pickle
    with open("./error/png_result/" + outdir.split('.')[0] + "_pred.pkl", "wb") as f:
        pickle.dump(mat, f)
    with open("./error/png_result/" + outdir.split('.')[0] + "_true.pkl", "wb") as f:
        pickle.dump(labels, f)
    with open("./error/png_result/" + outdir, 'w') as f:
        scipy.io.savemat(f, {'data': mat, 'labels': labels})  # append
    cm = confusion_matrix(pred, labels)
    with open("./error/png_result/" + outdir.split(".")[0] + ".pkl", "wb") as f:
        pickle.dump(cm, f)
        print cm
        np.savetxt("./error/png_result/" + outdir.split(".")[0] + "mfse" + ".csv", cm, delimiter=",")
...
def batch_extrac_featuretomat():
    ...
    modelist = [alexnetpath + "mnist/png_data/result1/caffe_alexnet_train_iter_188678.caffemodel", \
                alexnetpath + "mnist/png_data/result2/caffe_alexnet_train_iter_188630.caffemodel", \
                alexnetpath + "mnist/png_data/result3/caffe_alexnet_train_iter_188889.caffemodel",\
                alexnetpath + "mnist/png_data/result4/caffe_alexnet_train_iter_189054.caffemodel",\
                alexnetpath + "mnist/png_data/result5/caffe_alexnet_train_iter_189000.caffemodel", \
                alexnetpath + "mnist/png_data/result6/caffe_alexnet_train_iter_188635.caffemodel", \
                alexnetpath + "mnist/png_data/result7/caffe_alexnet_train_iter_189001.caffemodel", \
                alexnetpath + "mnist/png_data/result8/caffe_alexnet_train_iter_344000.caffemodel",\
                alexnetpath + "mnist/png_data/result9/caffe_alexnet_train_iter_240000.caffemodel", \
                alexnetpath + "mnist/png_data/result10/caffe_alexnet_train_iter_240000.caffemodel", \
                alexnetpath + "mnist/png_data/result11/caffe_alexnet_train_iter_240000.caffemodel", \
                ]
    datalist = ["/home/s.li/2017/gpu4/analysisfeatures/generatemat/data/svhn_ori_val/",
                "/home/s.li/2017/gpu4/analysisfeatures/generatemat/data/svhn_ori_val/",
                "/home/s.li/2017/gpu4/analysisfeatures/generatemat/data/svhn_ori_val/",
                "/home/s.li/2017/gpu4/analysisfeatures/generatemat/data/svhn_ori_val/",
                "/home/s.li/2017/gpu4/analysisfeatures/generatemat/data/svhn_ori_val/",
                "/home/s.li/2017/gpu4/analysisfeatures/generatemat/data/svhn_ori_val/",
    ...
    meanlist = [alexnetpath + "mnist/png_data/mean/mean1.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean2.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean3.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean4.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean5.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean6.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean7.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean8.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean9.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean10.binaryproto",
                alexnetpath + "mnist/png_data/mean/mean11.binaryproto",
                ]
