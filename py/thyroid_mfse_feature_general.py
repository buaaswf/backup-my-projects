...
def batch_extrac_featuretomat():
   ...
   #           ]
    ...
    datasetname = ""
    # outlist=[datasetname+"pool5.mat",datasetname+"conv5.mat",datasetname+"conv5-small.mat",datasetname + "thyroid2.mat", datasetname + "thyroid3.mat", datasetname + "GoogLent.mat"]
    outlist=[datasetname+"conv5-small.mat",datasetname+"pool5.mat",datasetname+"conv5.mat",datasetname + "thyroid2.mat", datasetname + "thyroid3.mat", datasetname + "GoogLent.mat"]
